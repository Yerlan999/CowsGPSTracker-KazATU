...
void enableDeepSleepMode(){
  ...
  if (ESP_OK == gpio_hold_en(GPIO_NUM_5)){ Monitor.println("HOLD 5"); } else { Monitor.println("NO HOLD 5"); }
  if (ESP_OK == gpio_hold_en(GPIO_NUM_2)){ Monitor.println("HOLD 2"); } else{ Monitor.println("NO HOLD 2"); }
